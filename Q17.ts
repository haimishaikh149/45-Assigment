...
// of your program.
let guestArr: string[] = ["haimi","ezal","moon","star"];

console.log("i can invited only two people to the dinner")
 while (guestArr.length>2){
    let removGuest: = guestArr.pop()
    console.log(`dear ${removGuest}, you are not invited to the dinner`)
 }
  guestArr.map ((item) => 
